...
export default function MainHome () {
    return (
        <div className="w-full grid grid-cols-4 gap-4 bg-[#75b7f9] py-6" style={{
            ...
            <h2 className="col-span-4 text-center font-extrabold text-lg underline">Lenguajes de Programacion 2024</h2>
        <Aside />
        <Article />
        <LangTable />
        </div>
